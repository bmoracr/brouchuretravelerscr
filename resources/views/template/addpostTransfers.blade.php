    ...
    <div class="body-container col-12">
      <a href="/admin/listpostTransfers/"  style="margin: 1rem;" ><i class="fas fa-arrow-circle-left" style="color:#ffff; font-size:3rem;"></i></a>
        <div class="container bg-light p-2 mt-4 text-dark rounded ">
            <div class="row p-4">
                <h1 class="title text-dark text-left">New Transfer</h1>
                ...
                @endif
                <form action="/admin/addpostTransfers" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="input-group mb-3">
                  ...
                  <div class="input-group mb-3">
                    <input type="text" name="name" class="form-control" placeholder="Transfer name" aria-label="Tour name" aria-describedby="tour-name" value="{{ old('name') }}">
                  </div>
                  <div class="input-group mb-3">
                ...
                <div class="form-check form-check-inline mb-3">
                  ...
                  <div class="input-group justify-content-center">
                    <div class="d-grid gap-2 col-6 mx-auto">
                        <button type="submit" class="btn btn-outline-danger ">SEND TRANSFERS</button>
                      </div>
                  </div>
