    ...
    <div class="container">
        <div class="bg-light mt-4 rounded">
            <div class="d-flex justify-content-around align-content-center align-self-center w-100">
                <div  class="d-flex justify-content-around align-self-center w-100"><h1 class="p-4 fs-2">Users List</h1></div>
                <div class="d-flex justify-content-around align-self-center w-50"><a href="/admin" ><i class="fas fa-home text-dark fs-4"></i></a></div>
                <div class="d-flex justify-content-around align-self-center w-50"><a href="/admin/addusers/" ><i class="fas fa-plus-circle text-dark fs-4"></i></a></div>
            </div>
            @if (session('status'))
            ...
            <ul class="list-group text-center w-100 m-0">
                ...
                <li class="list-group-item list-group-item-action d-flex justify-content-around p-4 align-content-center align-self-center w-100 m-0 {{$bg}}" > 
                    ...
                    <span class="w-50">
                        <a href="/admin/deleteusers/{{$item->id}}"><i class="fas fa-trash text-danger " style="font-size:1rem;"></i></a>
                    </span>
                    ...
                    <span class="w-50">
                        <a href="/admin/statususers/{{$item->id}}/{{$item->status}}"><i class="fas fa-circle {{$status}} " style="font-size:1rem;"></i></a>
                    </span>
                </li>
                @endforeach
              </ul>
