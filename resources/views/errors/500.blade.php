        ...
        <div class="login-section-form">
            ...
            <div class="login-container" style="color: #fff">
                ...
                <div class="login-form-inputs">
                    <div class="login-form-inputs">
                        <div class="login-form-inputs-item"><h4>Oops! Something wrong.</h4></div>  
                        ...
                        <div class="login-form-inputs-item"><h4><a href="/" style="color: #f33f3f; text-decoration:none;"> Try Again </a></h4></div>  
                    </div>   
                </div>
